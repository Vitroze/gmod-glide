...
Glide.CMD_UPLOAD_ENGINE_STREAM_PRESET = 9
Glide.CMD_UPLOAD_MISC_SOUNDS_PRESET = 10
Glide.CMD_RELOAD_VSWEP = 11
Glide.CMD_IS_USING_CAM_CONTROLLER = 12
Glide.CMD_FORCE_THIRDPERSON = 13
